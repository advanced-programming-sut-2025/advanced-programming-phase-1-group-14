...
public class Farm extends Place {
    ...
    private House house;
    private User owner;
    public Farm(User owner, int startX, int startY) {
        this.x = startX;
        this.y = startY;
        this.owner = owner;
    }
...
//    }
    ...
    private boolean isInsideGreenHouse(int x, int y) {
        return greenHouse != null && x >= greenHouse.getX() && x < greenHouse.getX() + greenHouse.getWidth() && y >= greenHouse.getY() && y < greenHouse.getY() + greenHouse.getHeight();
    }
...
//    }
    ...
    private boolean isInsideQuarry(int x, int y) {
        return quarry != null && x >= quarry.getX() && x < quarry.getX() + quarry.getWidth() && y >= quarry.getY() && y < quarry.getY() + quarry.getHeight();
    }

    private boolean isInsideHouse(int x, int y) {
        return house != null && x >= house.getX() && x < house.getX() + house.getWidth() && y >= house.getY() && y < house.getY() + house.getHeight();
    }
